		                ...
		                <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
	         			...
	         			<form action="approval" method="post" >
		         			<table>
		         				...
		         				<tr>
		         					<td>
		         						<textarea name="approveOpinion" rows="5" cols="55"></textarea>
		         					</td>
		         				</tr>
		         				<tr>
		         					<td>&nbsp;</td>
		         				...
		         				<tr>
		         					<td colspan="2">
					         			<input name="button" type="submit" class="submit_01" value="审批通过" />
					                	<input name="button" class="submit_01" type="submit" value="打回" />
			                		</td>
			                	</tr>
		         			</table>
	         			</form>
