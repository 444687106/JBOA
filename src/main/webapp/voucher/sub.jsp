					...
					<div class="pages">
						...
						<form id="form1" name="form1" method="post" action="sub">
 		                	<table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
								...
								<tr>
									<td>
										<textarea name="textarea" id="textarea" cols="55" rows="3"></textarea>
									</td>
								</tr>
								<!--表单提交行-->
								<tr>
									<td colspan="4" class="submit">
										<s:if test="#session.loginPosition == '财务'">
						                	<input type="submit" name="button" id="button" value="审批通过" class="submit_01" />
											<input class="submit_01" type="button" id="back" value="返回" /> 
						                </s:if>  
						                <s:else>
						                	<input type="submit" name="button" id="button" value="审批通过" class="submit_01" />
											<input type="submit" name="button" id="button" value="审批拒绝" class="submit_01" />
											<input type="submit" name="button" id="button" value="打回" class="submit_01" />
							                <input class="submit_01" type="button" id="back" value="返回" />    
						                </s:else>
									</td>
								</tr>  
